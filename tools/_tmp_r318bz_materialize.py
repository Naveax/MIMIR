...
TOKENS = {
    ...
    '__BY_PR_KNOWLEDGE_RUN__': 'by_pr_knowledge_run',
    '__BY_PR_KNOWLEDGE_JOB__': 'by_pr_knowledge_job',
    '__BY_MAIN_CI_RUN__': 'by_main_ci_run',
    '__BY_MAIN_CI_JOB__': 'by_main_ci_job',
    '__BY_MAIN_KNOWLEDGE_RUN__': 'by_main_knowledge_run',
    '__BY_MAIN_KNOWLEDGE_JOB__': 'by_main_knowledge_job',
}
