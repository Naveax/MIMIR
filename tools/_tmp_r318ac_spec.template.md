...
R3.18AB evidence head/tree           __AB_HEAD__ / __AB_TREE__
R3.18AB authority run/job            __AB_RUN__ / __AB_JOB__ SUCCESS
R3.18AB same-head CI                 __AB_CI_RUN__ / __AB_CI_JOB__ SUCCESS
R3.18AB artifact                     __AB_ARTIFACT__ / __AB_ARTIFACT_SIZE__ bytes
R3.18AB artifact digest              __AB_ARTIFACT_DIGEST__
