...
if len(enums) != 1 or len(structs) != 1 or len(fns) != 1:
    raise SystemExit(f'unexpected BS declarations enum={enums} struct={structs} fn={fns}')

old_enum, old_struct, old_fn = enums[0], structs[0], fns[0]
...
print(f'normalized BS declarations: {old_enum} -> {new_enum}')
