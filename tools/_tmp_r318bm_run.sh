...
'''
if '_r318bm_strip_benchmark_only_dev_dependencies' in s:
    raise SystemExit('R3.18BM benchmark dev-dependency shim already present')
p.write_text(s + append, encoding='utf-8', newline='\n')
